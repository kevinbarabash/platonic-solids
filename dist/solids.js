...
(function (geom) {
    ...
    geom.createTetrahedron = createTetrahedron;
    ...
    geom.createOctahedron = createOctahedron;
    function createDodecahedron(size) {
        size = size / 3;
        var mesh = new geom.Mesh();
    ...
    geom.createDodecahedron = createDodecahedron;
    function createIcosahedron(size) {
        size = size / 3;
        var mesh = new geom.Mesh();
